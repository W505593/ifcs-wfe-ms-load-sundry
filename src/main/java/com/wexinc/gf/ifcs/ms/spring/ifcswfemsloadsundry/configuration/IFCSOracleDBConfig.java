...
@EnableJpaRepositories(
        basePackages = "com.wexinc.gf.ifcs.ms.spring.ifcswfemsloadsundry.repositories.ifcs",
        entityManagerFactoryRef = "ifcsEntityManager",
        transactionManagerRef = "ifcsTransactionManager")
@EnableTransactionManagement
public class IFCSOracleDBConfig {
    ...
    @Bean
    public LocalContainerEntityManagerFactoryBean ifcsEntityManager() {
        final LocalContainerEntityManagerFactoryBean em = new LocalContainerEntityManagerFactoryBean();
        em.setDataSource(ifcsDataSource());
    ...
    @Bean
    public PlatformTransactionManager ifcsTransactionManager() {
        final JpaTransactionManager transactionManager = new JpaTransactionManager();
        transactionManager.setEntityManagerFactory(ifcsEntityManager().getObject());
